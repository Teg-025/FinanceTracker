...
export default function AuthPage({ setLoginState }) {  // Accept setLoginState as a prop
    ...
    async function handleSignIn(event) {
        ...
        try {
            ...
            if (data.authToken) {
                ...
                setLoginState(true); // Update the login state in App.js
                navigate("/")
            }
        } catch (err) {
            ...
            <div className={`auth-page-container ${isSignInState ? "right-panel-active" : ""}`}>
                ...
                <div className="form-container signIn-container">
                    <form className="right-box-signIn" onSubmit={handleSignIn}>
                        ...
                        {err && <p className="error">Your credentials are invalid. Please try again.</p>}
                    </form>
                </div>
